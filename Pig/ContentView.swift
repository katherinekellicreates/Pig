...
//  Pig
//
//  Created by Katherine Pizzirusso on 10/22/25.
//
        ...
        ZStack {
            ...
            VStack {
                ...
                VStack(alignment: .leading) {
                    Text("In the game of Pig, players take indiviual turns. Each turn, a player repeatedly rolls a single die until either a pig is rolled or the player decides to \"hold\".")
                        .padding()
                    Text("If a player rolls a pig, they score nothing and it is the next player's turn.")
                        .padding()
                    Text("If the player rolls any other number, it is the next player's turn.")
                        .padding()
